...
(function(factory) {
  ...
  var START_EVENT = 'mousedown touchstart MSPointerDown' // mousedown touchstart MSPointerDown pointerdown
  var END_EVENT   = 'mouseup touchend MSPointerUp' // mouseup touchend MSPointerUp pointerup
  var MOVE_EVENT  = 'mousemove touchmove MSPointerMove scroll' // mousemove touchmove MSPointerMove pointermove scroll
  ...
  Dragging.prototype.start = function(parent, el, e, handle) {
    ...
    $(el).addClass('is-active') //active class add
    return this.el
  }
  ...
  Dragging.prototype.stop = function(e) {
    ...
    $(el).removeClass('is-active') //active class remove
  ...
  Sortable.prototype.drop = function(e) {
    ...
    if (newIndex !== this.index) {
      ...
      dragging.el.removeClass('is-active')
    }
  ...
  // Docs : http://rkusa.github.io/touch-dnd/sortable.html
