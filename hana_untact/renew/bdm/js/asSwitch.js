...
(function(global, factory) {
  ...
  var asSwitch = (function() {
    function asSwitch(element, options) {
      ...
      this.skinClass = this.$element.is('[data-skin]') ? this.$element.attr('data-skin') : this.options.skin;
      this.classes = {
        skin: this.namespace + '_' + this.skinClass,
        on: this.namespace + '_on',
        off: this.namespace + '_off',
        disabled: this.namespace + '_disabled'
      };

      this.$wrap.addClass(this.namespace).addClass(this.elementClass);
